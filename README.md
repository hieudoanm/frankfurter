...
Frankfurter is a focused project in this monorepo that delivers a practical tool with a clean user experience across platforms.

## ✨ 2. Features

1. [x] Core functionality tailored to Frankfurter
...
- 🌐 [Live Demo](https://hieudoanm.github.io/frankfurter/)

## 🚀 4. Usage

- 🌐 [Web](https://hieudoanm.github.io/frankfurter/)
- 💻 [CLI](https://github.com/hieudoanm/frankfurter/releases)
- 📱 [Mobile](https://github.com/hieudoanm/frankfurter/releases)
- 🖥️ [Desktop](https://github.com/hieudoanm/frankfurter/releases)
  - 🍎 [MacOS](https://github.com/hieudoanm/frankfurter/releases/tag/macos-latest)
  - 🐧 [Ubuntu](https://github.com/hieudoanm/frankfurter/releases/tag/ubuntu-latest)
  - 🪟 [Windows](https://github.com/hieudoanm/frankfurter/releases/tag/windows-latest)
